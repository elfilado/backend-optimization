...
fn main() {
    let graph = vec![
        vec![0, 7, 5, 2, 0, 0, 2, 4, 3],
		vec![7, 0, 0, 0, 3, 0, 0, 0, 0],
		vec![5, 0, 0, 10, 4, 0, 0, 0, 0],
		vec![2, 0, 10, 0, 0, 2, 0, 0, 0],
		vec![0, 3, 4, 0, 0, 6, 0, 0, 0],
		vec![0, 8, 0, 2, 6, 0, 0, 0, 0],
		vec![2, 0, 0, 0, 0, 0, 0, 5, 0],
		vec![4, 0, 0, 0, 0, 0, 5, 0, 1],
